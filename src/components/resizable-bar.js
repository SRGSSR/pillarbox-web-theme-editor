 ...
 *
 * @cssproperty [--resizable-bar-margin-inline=1em] - The margin along the split axis of the resizable bar.
 * @cssproperty [--resizable-bar-resizer-bg-color=#575454] - The background color of the resizable bar.
 * @cssproperty [--resizable-bar-resizer-width=0.3em] - The thickness of the resizable bar.
 * @cssproperty [--resizable-bar-resizer-height=50%] - The length of the resizable bar.
