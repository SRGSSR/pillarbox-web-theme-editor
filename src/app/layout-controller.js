...
/**
 * The context of the layout controller.
 *
 * @typedef {Object} LayoutControllerContext
 * @property {HTMLElement} split The main `resizable-split-view` element.
 * @property {HTMLElement} sidebar The sidebar element hosting the file tree.
 * @property {HTMLElement} sidebarButton The sidebar toggle button.
 * @property {HTMLElement} previewButton The preview toggle button.
 * @property {HTMLElement} dockButton The dock position toggle button.
 */
 ...
 *
 * @param {LayoutControllerContext} ctx The controller context.
 */
